...
* [Main Scripts]
*
* Template Name : Talha Dev
* Version       : 1.0.0
* Author        : Talha
* Author URL    : https://webdevtalha
* Description   : Build Your Next level Website
* Tags          : portfolio
* 
----------------------------------------------*/
...
function nextStep() {
    let getInputEmail = document.forms["myForm"]["email"].value;
    let getInputName = document.forms["myForm"]["name"].value;
    let getInputPhone = document.forms["myForm"]["phone"].value;

    if (getInputEmail == "") {
        $(".inputEmail").addClass('b-red');
        return false;
    } 
    else if (getInputName == "") {
        $(".inputName").addClass('b-red');
        return false;
    }
    else if (getInputPhone == "") {
        $(".inputPhone").addClass('b-red');
        return false;
    }
    
    else{        
       $(".stepTitle1").addClass('hide');       
       $(".ProLi2").addClass('active');
       $(".step1").addClass('hide');
       $(".step2").removeClass('hide');
       $(".stepTitle2").removeClass('hide');     
...
function nextStep2() {
    let getInputCompany = document.forms["myForm"]["company"].value;
    let getInputmanager = document.forms["myForm"]["manager"].value;
    let getInputBudget = document.forms["myForm"]["budget"].value;

    if (getInputCompany == "") {
        $(".inputCompany").addClass('b-red');
        return false;
    }
    else if (getInputmanager == "") {
        $(".inputManager").addClass('b-red');
        return false;
    }
    else if (getInputBudget == "") {
        $(".inputBudget").addClass('b-red');
        return false;
    }
    else {
        $(".stepTitle2").addClass('hide');
        $(".ProLi3").addClass('active');
        $(".step2").addClass('hide');
        $(".step3").removeClass('hide');
        $(".stepTitle3").removeClass('hide');
    }
